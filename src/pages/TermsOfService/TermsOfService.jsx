  ...
  return (
    <div className="min-h-screen bg-gray-900 p-8">
      <div className="max-w-7xl mx-auto px-4 py-8 bg-gray-900">
        ...
        <div className="section">
          <h2 className="text-2xl font-semibold text-blue-500 mt-6">13. Cancellation and Ticket Change Policy</h2>
          <p className="text-gray-700 mb-4">
            Users may cancel their tickets within 7 days prior to the event. Cancellations made after this period will not be allowed.
            Additionally, users are prohibited from changing their tickets within 3 days of the event.
            All changes must be requested at least 3 days before the event date.
          </p>
        </div>
